package com.davidrt.chapter_one;
...
public class PhraseOMatic {
	...
	public static void main(String[] args) {
		...
		String[] wordListOne = {"24/7","multi-Tier","30,000 foot", "B-to-B","win-win","front-end",
								"web-based","pervasive","smart","six-sigma","critical-patch","dynamic"};
		...
		String[] wordListThree = {"process","tipping-point","solution","architecture","core competancy",
